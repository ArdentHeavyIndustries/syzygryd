...
uint8 min3( uint8 a, uint8 b, uint8 c )
{ return (a<b && a<c) ? a : (b<c ? b : c); }

uint8 max3( uint8 a, uint8 b, uint8 c )
{ return (a>b && a>c) ? a : (b>c ? b : c); }
...
void RGBtoHSV( rgb_t rgb, hsv_t *hsv )
{
	...
	hsv->h = (uint16)(h/360 * HUE_MAX);
	hsv->s = (uint8)(s * SAT_MAX);
	hsv->v = (uint8)(v * VAL_MAX);
}
